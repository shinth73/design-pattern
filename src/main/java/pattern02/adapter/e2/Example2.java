...
public class Example2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        doSomething(new MySynchronizedList(new MyJavaListAdapter(new ArrayList<MyObject>())));
        doSomething(new MySynchronizedList(new MyJavaListAdapter(new LinkedList<MyObject>())));
    }
}