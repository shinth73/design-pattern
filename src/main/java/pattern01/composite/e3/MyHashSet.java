...
public class MyHashSet extends MyAbstractCollection {
    ...
    public boolean equals(MyObject obj) {
        ...
        MyHashSet mySet = (MyHashSet)obj;
        if (count != mySet.count) return false;
        MyIterator it = getIterator();
        while (!it.isEnd())
            if (mySet.contains(it.getNext()) == false) return false;
        return true;
    }
    ...
    public String toString() {
        ...
        builder.append("MyHashSet( ");
        MyIterator it = getIterator();
        while (!it.isEnd())
            builder.append(it.getNext()).append(' ');
        builder.append(')');
